...
public class RecipeBlastingFunction extends VarArgFunction {
    @Override
    public Varargs invoke(Varargs args) {
        ...
        RecipeBuilder.SmeltingRecipeBuilder recipeBuilder = RecipeBuilder.blasting(result);
        ...
        String path = resultString.replace(":", "_") + "_blasting_" + Integer.toHexString(recipeJson.hashCode());
