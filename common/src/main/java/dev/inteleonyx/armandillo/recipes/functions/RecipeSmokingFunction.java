...
public class RecipeSmokingFunction extends VarArgFunction {
    @Override
    public Varargs invoke(Varargs args) {
        ...
        RecipeBuilder.SmeltingRecipeBuilder recipeBuilder = RecipeBuilder.smoking(result);
        ...
        String path = resultString.replace(":", "_") + "_smoking_" + Integer.toHexString(recipeJson.hashCode());
